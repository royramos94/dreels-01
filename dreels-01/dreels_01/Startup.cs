...
using dreels_01.ViewModels;
using dreels_01.Helpers;
using dreels_01.Authorization;
...
namespace dreels_01
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("dreels_01"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "dreels_01 API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "dreels_01 API V1");
            });
